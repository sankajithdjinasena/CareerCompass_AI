          ...
          <div className="animate-fade-up w-full max-w-md bg-white/5 border border-white/10 backdrop-blur-md p-10">
            ...
            {!sent ? (
                  ...
                  <div>
                    <div className="relative">
                      ...
                      <input type="email" placeholder="Email Address" value={email}
                        ...
                        className="auth-input" id="forgot-email" />
                    </div>
              ...
              <div className="text-center py-6">
                {/* Success state */}
                <div className="w-16 h-16 bg-white/5 border border-white/10 rounded-full flex items-center justify-center mx-auto mb-6 text-2xl">
                  ✉️
                </div>
                ...
                <button
                  ...
                  className="auth-btn mt-8" id="forgot-go-reset"
                >
            ...
            <div className="mt-8 border-t border-white/10 pt-6 text-center">
              <button onClick={() => onNavigate('login')}
                className="text-slate-400 hover:text-white text-[11px] tracking-wider transition-colors flex items-center gap-2 mx-auto" id="forgot-back-login">
