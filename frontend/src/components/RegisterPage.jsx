...
import { 
  ...
  ShieldCheck, CheckCircle, FileText, Scale, Cpu, Sparkles, Sun, Moon 
} from 'lucide-react';
      ...
      <div className="min-h-screen font-montserrat flex flex-col relative bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-white transition-colors duration-200 overflow-x-hidden">
        ...
        <main className="flex-1 flex flex-col items-center justify-center px-4 relative z-10 py-10 md:py-14">
          ...
          <div className="w-full max-w-4xl grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
            ...
            <div className="lg:col-span-7 animate-fade-up bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-8 md:p-10 rounded-2xl shadow-xl transition-colors">
              <p className="text-xs tracking-widest uppercase text-brand-600 dark:text-brand-400 mb-2 font-bold">Create Free Account</p>
              <h1 className="text-2xl md:text-3xl font-extrabold tracking-tight uppercase text-slate-900 dark:text-white mb-6">Register</h1>
              ...
              <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-4">
                ...
                <div className="pt-2">
                  <label className="flex items-start gap-3 cursor-pointer group">
                    <input
                      ...
                      className="mt-1 w-4 h-4 rounded bg-slate-100 dark:bg-slate-800 border-slate-300 dark:border-slate-700 text-brand-600 focus:ring-brand-500 cursor-pointer"
                    />
                    <span className="text-xs text-slate-600 dark:text-slate-300 font-medium leading-relaxed select-none">
                      I agree to the{' '}
                      <button
                        type="button"
                  ...
                  {errors.terms && <span className="text-red-500 text-xs font-bold mt-1 block pl-7">{errors.terms}</span>}
                </div>
                ...
                <button 
                  ...
                  id="reg-submit"
                >
                  {loading ? <span className="w-4 h-4 border-2 border-white border-t-transparent rounded-full animate-spin" /> : <>Create Account <ArrowRight size={15} /></>}
                </button>
              </form>
              ...
              <div className="mt-6 border-t border-slate-200 dark:border-slate-800 pt-5 text-center">
                <p className="text-slate-600 dark:text-slate-400 text-xs font-medium">
                  ...
                  <button onClick={() => onNavigate('login')} className="text-brand-600 dark:text-brand-400 font-bold hover:underline transition-all" id="reg-go-login">
                    Sign In
                  </button>
                </p>
              </div>
            ...
            <div className="lg:col-span-5 flex flex-col justify-between gap-6 animate-fade-up">
              <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-8 rounded-2xl shadow-xl flex flex-col justify-between h-full transition-colors">
                <div>
                  <div className="flex items-center gap-2.5 mb-4 text-brand-500">
                    <ShieldCheck size={22} />
                    <h3 className="text-xs font-extrabold tracking-wider uppercase text-slate-900 dark:text-white">
                  ...
                  <div className="space-y-4">
                    ...
                    <div 
                      ...
                      className="p-4 bg-slate-50 dark:bg-slate-800/50 hover:bg-slate-100 dark:hover:bg-slate-800 border border-slate-200 dark:border-slate-700/60 rounded-xl transition-all cursor-pointer group"
                    >
                      <div className="flex items-center justify-between mb-1">
                        <div className="flex items-center gap-2">
                          <FileText size={15} className="text-brand-500" />
                          <span className="text-xs font-bold text-slate-900 dark:text-white tracking-wide">Zero Foundation Training</span>
                        </div>
                        <span className="text-xs text-brand-600 dark:text-brand-400 font-mono font-bold group-hover:translate-x-0.5 transition-transform">&rarr;</span>
                      </div>
                    ...
                    >
                      <div className="flex items-center justify-between mb-1">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-xs font-bold text-slate-900 dark:text-white tracking-wide">Bias-Free Scoring</span>
                        </div>
                        <span className="text-xs text-brand-600 dark:text-brand-400 font-mono font-bold group-hover:translate-x-0.5 transition-transform">&rarr;</span>
                      </div>
                      <p className="text-xs text-slate-500 dark:text-slate-400 font-medium leading-relaxed">
                    ...
                    >
                      <div className="flex items-center justify-between mb-1">
                        <div className="flex items-center gap-2">
                          <Scale size={15} className="text-brand-500" />
                          <span className="text-xs font-bold text-slate-900 dark:text-white tracking-wide">Data Portability & Erasure</span>
                        </div>
                        <span className="text-xs text-brand-600 dark:text-brand-400 font-mono font-bold group-hover:translate-x-0.5 transition-transform">&rarr;</span>
                      </div>
                      <p className="text-xs text-slate-500 dark:text-slate-400 font-medium leading-relaxed">
                ...
                <div className="pt-6 mt-6 border-t border-slate-200 dark:border-slate-800 flex items-center justify-between text-xs text-slate-500 dark:text-slate-400 uppercase tracking-wider font-bold">
