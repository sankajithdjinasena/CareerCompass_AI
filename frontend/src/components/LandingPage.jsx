      ...
      >
        ...
        <header className="px-6 md:px-12 py-8 flex justify-between items-center relative z-10 text-[10px] md:text-xs uppercase tracking-[0.2em] font-medium text-slate-200">
          <div className="hidden md:flex gap-8 lg:gap-12 items-center">
            <span className="cursor-pointer hover:text-white transition-colors" onClick={() => onNavigate && onNavigate('contact')}>Contact</span>
            <button 
              type="button" 
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl w-full pb-20">
            {[
              ...
              <div key={i} className="bg-white/5 border border-white/10 p-8 rounded-none backdrop-blur-md text-center hover:bg-white/10 transition-colors">
                ...
                <p className="text-slate-200 text-xs tracking-wider leading-relaxed font-light">{feature.desc}</p>
              </div>
            ))}
          </div>
        </main>
          ...
          <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-0 relative">
            ...
            {[
              ...
              <div key={i} className="flex flex-col items-center px-8 relative">
                ...
                <p className="text-slate-200 text-xs leading-relaxed font-light tracking-wider">{item.desc}</p>
              </div>
            ))}
          </div>
        </section>
        ...
        <section className="relative z-10 py-24 px-6 text-center border-t border-white/5 bg-slate-900/80 backdrop-blur-xl">
          ...
          <p className="text-slate-200 text-xs tracking-wider font-light max-w-xl mx-auto mb-16">Your autonomous AI team — each agent is a specialist, working together to build your complete career strategy.</p>
          ...
          <div className="max-w-5xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <div key={i} className="bg-white/5 border border-white/10 p-8 backdrop-blur-md text-left hover:bg-white/10 transition-all group">
                ...
                <p className="text-slate-200 text-xs leading-relaxed font-light tracking-wider mb-5">{agent.desc}</p>
                <span className="text-[9px] tracking-[0.2em] uppercase border border-white/10 px-3 py-1 text-slate-200 font-light">{agent.tag}</span>
              </div>
            ))}
          </div>
        </section>
